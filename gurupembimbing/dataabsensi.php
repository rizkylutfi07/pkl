...
$result = $koneksi->query("SELECT t.tanggal, t.nisn, g.nama_siswa, g.kelas, t.status, t.keterangan, t.lokasi
                           FROM tb_absensi t
                           LEFT JOIN tb_siswa g ON t.nisn = g.nisn
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="aaa" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Tanggal</th>
                                            <th>NISN</th>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SMSK PGRI Banyupuith 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
