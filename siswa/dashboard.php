...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$sudah_absen) {
    ...
    $sql = "INSERT INTO tb_absensi (nisn, tanggal, status, keterangan, lokasi, jam_absensi, id_guru) VALUES ('$username', '$tanggal_hari_ini', '$status', '$keterangan', '$lokasi', '$waktu_absensi', '$id_guru')";
