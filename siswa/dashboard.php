...
$query = "SELECT * FROM tb_absensi WHERE nisn = '$username' AND tanggal = '$tanggal_hari_ini'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$sudah_absen) {
    ...
    $query = "INSERT INTO tb_absensi (nisn, tanggal, nama_siswa, kelas, status, keterangan, lokasi, id_guru, jam_absensi, tempat_pkl) VALUES ('$nisn', '$tanggal_hari_ini', '$nama_siswa', '$kelas','$status', '$keterangan', '$lokasi', '$guru_pembimbing', '$waktu_absensi', '$tempat_pkl')";
        ...
        <div class="container">
            <header
                ...
                <a
                    ...
                    <img class="px-1 bi" src="../dist/svg/logo.png" alt="" width="40">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a href="jurnal.php" class="nav-link">Data Jurnal</a></li>
