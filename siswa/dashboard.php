...
$result_siswa = $koneksi->query("SELECT * FROM tb_siswa WHERE nisn = '$username'");
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$sudah_absen) {
    ...
    $kelas = $_POST['kelas'];
    $jam_absensi = date('H:i:s'); // Mengambil waktu saat ini

    $sql = "INSERT INTO tb_absensi (nisn, nama_siswa, kelas, tanggal, status, keterangan, lokasi, jam_absensi, id_guru, nama_dudi, id_dudi, nama_guru) VALUES ('$username', '$nama_siswa', '$kelas', '$tanggal_hari_ini', '$status', '$keterangan', '$lokasi', '$jam_absensi', '$id_guru', '$nama_dudi', '$id_dudi','$nama_guru')";
...
<body>
    ...
    <main>
        ...
        <div class="container">
            ...
            <p>Selamat datang, <?php echo htmlspecialchars($siswa['nama_siswa']); ?></p>
            <p>Tempat PKL : <?php echo htmlspecialchars($siswa['nama_dudi']); ?></p>
            ...
            <form action="" method="POST" onsubmit="return getLocation()">
                ...
                <input type="hidden" id="nama_siswa" name="nama_siswa" value="<?php echo $siswa['nama_siswa']; ?>">
                <input type="hidden" id="id_guru" name="id_guru" value="<?php echo $siswa['id_guru']; ?>">
                <input type="hidden" id="nama_guru" name="nama_guru" value="<?php echo $siswa['nama_guru']; ?>">
                <input type="hidden" id="id_dudi" name="id_dudi" value="<?php echo $siswa['id_dudi']; ?>">
                <input type="hidden" id="nama_dudi" name="nama_dudi" value="<?php echo $siswa['nama_dudi']; ?>">
                <input type="hidden" id="kelas" name="kelas" value="<?php echo $siswa['kelas']; ?>">
        ...
        <div class="container">
            <footer
                ...
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <span class="mb-3 mb-md-0 text-body-secondary">&copy; 2024 Esgriba, </span>
                </div>
