...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE tb_jurnal SET tanggal = '$tanggal', id_dudi = '$id_dudi', deskripsi_kegiatan = '$deskripsi_kegiatan', evadir_personal = '$evadir_personal', evadir_sosial = '$evadir_sosial' WHERE id_jurnal = '$id_jurnal'";
    if (mysqli_query($koneksi, $query)) {
        echo "<script>alert('Data berhasil diubah'); window.location.href='data_jurnal.php';</script>";
    } else {
...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data" onsubmit="return getLocation()">
            ...
            <input type="text" id="id_dudi" name="id_dudi" class="form-control" value="<?php echo $row['id_dudi']; ?>" readonly required hidden>
